...
namespace Water.Endpoint
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddTransient<WaterLevelLogic>();
            ...
            builder.Services.AddIdentity<IdentityUser, IdentityRole>(
                ...
                .AddEntityFrameworkStores<WaterContext>()
            ...
            {
                option.SwaggerDoc("v1", new OpenApiInfo { Title = "Water API", Version = "v1" });
